...
import menu
import editMaterial, detailMaterial
import dataBase
class view_assign():
    # constructor
    def __init__(self):
    ...
    def assign(self, data):
        ...
        self.tr.heading('#4', text="Material")
        ...
        data = dataBase.viewMaterial(self.data)
        print(data)
        if len(data)>0:
            for i in data:
