...
class ImageWidget:
    ...
    def __init__(self):
        self.root = Tk()
        self.root.title('Edit Assignment Page')
    ...
    def mainFrame(self, matId, data):
        ...
        self.fileLabel = Label(self.frame1, text='Assignment', font=('Rockwell',16),bg='#205950',fg='#F9F37F').place(x=30, y=200)
        ...
        res = dataBase.getassignments(self.matId)
        if res:
    ...
    def login(self):
        ...
        if self.dropDown3.get() != "":
            ...
            if(self.dropDown3.get() == ''):
                ...
                pass
                res  = dataBase.editassignments(data)
                if res:
                    print(data)
