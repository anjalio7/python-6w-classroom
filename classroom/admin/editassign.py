...
class edit_assign:
    ...
    def __init__(self):
        self.root = Toplevel()
        self.root.title('Add assign Page')
    ...
    def firstFrame(self,data):
        ...
        self.dropDown1 = Combobox(self.frame1, textvariable=self.comboValue1, values=self.options,font=('Times New Roman',12),)
        ...
        self.dropDown2 = Combobox(self.frame1, textvariable=self.comboValue2, values=self.options,font=('Times New Roman',12),)
        ...
        self.comboValue3 = StringVar()
        self.optiondata = ('',)
        self.dropDown3=Combobox(self.frame1,textvariable=self.comboValue3,values=self.optiondata,font=('Times New Roman',12))
        self.dropDown3.place(x=210,y=200)

        i = dataBase.editAssign(data)
        print("i",i)
        self.dropDown1.insert(0,(i[0],i[1]))
        self.dropDown2.insert(0,(i[2],i[3]))
        self.dropDown3.insert(0,(i[4],i[5]))
    ...
    def login(self):
        ...
        if self.dropDown3.get()!="":
            ...
            if(self.dropDown1.get() == ''):
                ...
                res  = dataBase.updateassign_item(data)
                if res:
                    print(data)
